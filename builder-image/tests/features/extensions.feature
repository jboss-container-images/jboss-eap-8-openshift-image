...
Feature: EAP extensions tests
  ...
  Scenario: Build server image
    Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app-advanced-extensions with env and True using eap81-dev
    | variable                             | value         |
