...
Feature: EAP s2i tests
  ...
  Scenario: Test extension called at startup.
    Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app-extension with env and true using eap8-beta-dev
    | variable                             | value         |
    ### PLACEHOLDER FOR CLOUD CUSTOM TESTING ###
  ...
  Scenario: Test custom settings with galleon
    Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app-settings with env and true using eap8-beta-dev
    | variable                             | value         |
    ### PLACEHOLDER FOR CLOUD CUSTOM TESTING ###
...
Scenario: Multiple deployments via deployments directory
   Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app-multi-deployments with env and True using eap8-beta-dev
   | variable                 | value           |
  ...
  Scenario: Multiple deployments
   Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app-multi-deployments2 with env and True using eap8-beta-dev
   | variable                 | value           |
  ...
  Scenario: Failing Multiple deployments
   Given failing s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app-multi-deployments-invalid using eap8-beta-dev
   | variable                 | value           |
   | MAVEN_S2I_ARTIFACT_DIRS | server/target,app1/target,app2/target |
   ### PLACEHOLDER FOR CLOUD CUSTOM TESTING ###

  Scenario: Multiple deployments from both MAVEN_S2I_ARTIFACT_DIRS and deployments dir
   Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app-multi-deployments3 with env and True using eap8-beta-dev
   | variable                 | value           |
