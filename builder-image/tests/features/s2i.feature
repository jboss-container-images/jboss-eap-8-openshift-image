...
Feature: EAP s2i tests
  ...
  Scenario: Build the image with a server
    Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app with env and True using eap82-beta-dev
    | variable                             | value         |
  ...
  Scenario: Test extension called at startup.
    Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app-extension with env and true using eap82-beta-dev
    | variable                             | value         |
    ### PLACEHOLDER FOR CLOUD CUSTOM TESTING ###
  ...
  Scenario: Test extension called at build time, copy a file inside JBOSS_HOME.
    Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app-extension2 with env and true using eap82-beta-dev
    | variable                             | value         |
    ### PLACEHOLDER FOR CLOUD CUSTOM TESTING ###
    Then exactly 2 times container log should contain WFLYSRV0025:
  ...
  Scenario: Test custom settings with galleon
    Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app-settings with env and true using eap82-beta-dev
    | variable                             | value         |
    ### PLACEHOLDER FOR CLOUD CUSTOM TESTING ###
  ...
  Scenario: Test execution of user CLI operations at S2I phase
    Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/vanilla-eap/test-app-s2i-cli-scripts with env and true using eap82-beta-dev
     | variable                               | value                                                 |
  ...
  Scenario: Test jaxrs-server -jpa +jpa-distributed
    Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app-jpa2lc with env and True using eap82-beta-dev
    | variable                             | value         |
    ### PLACEHOLDER FOR CLOUD CUSTOM TESTING ###
    Then exactly 2 times container log should contain WFLYSRV0025:
  ...
  Scenario: Test jaxrs-server +ejb-lite, -ejb-local-cache +ejb-dist-cache. Verify JGroups configuration added by ejb-dist-cache
    Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app-ejb with env and True using eap82-beta-dev
    | variable                             | value         |
    ### PLACEHOLDER FOR CLOUD CUSTOM TESTING ###
    Then exactly 2 times container log should contain WFLYSRV0025:
    Then check that page is served
  ...
  Scenario: Test building and running slim application
    Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image  from test/test-app-slim with env and true using eap82-beta-dev
    | variable                             | value         |
    ### PLACEHOLDER FOR CLOUD CUSTOM TESTING ###
    Then exactly 2 times container log should contain WFLYSRV0025:

  Scenario: Test failing packaging.
    Given failing s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app-invalid using eap82-beta-dev
    | variable                             | value         |
    ### PLACEHOLDER FOR CLOUD CUSTOM TESTING ###

Scenario: Multiple deployments via deployments directory
   Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app-multi-deployments with env and True using eap82-beta-dev
   | variable                 | value           |
  ...
  Scenario: Multiple deployments
   Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app-multi-deployments2 with env and True using eap82-beta-dev
   | variable                 | value           |
  ...
  Scenario: Failing Multiple deployments
   Given failing s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app-multi-deployments-invalid using eap82-beta-dev
   | variable                 | value           |
   | MAVEN_S2I_ARTIFACT_DIRS | server/target,app1/target,app2/target |
   ### PLACEHOLDER FOR CLOUD CUSTOM TESTING ###

  Scenario: Multiple deployments from both MAVEN_S2I_ARTIFACT_DIRS and deployments dir
   Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app-multi-deployments3 with env and True using eap82-beta-dev
   | variable                 | value           |
