...
Feature: Openshift EAP jgroups
  ...
  Scenario: Build server image
    Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app-clustering with env and true using eap82-beta-dev
    | variable                             | value         |
