...
Feature: EAP Legacy s2i tests
  ...
  Scenario: Test provisioning.xml file
    Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/vanilla-eap/test-app-local-provisioning with env and True using eap82-dev
      | variable                             | value         |
...
Scenario: Test external driver created during s2i.
 ...
 Scenario: Multiple deployments legacy
   Given s2i build https://github.com/jboss-container-images/jboss-eap-8-openshift-image from test/test-app-multi-deployments-legacy with env and True using eap82-dev
   | variable                 | value           |
