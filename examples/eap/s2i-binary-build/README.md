...
```
oc import-image registry.redhat.io/jboss-eap-8/eap81-openjdk17-builder-openshift-rhel9:latest --from=registry.redhat.io/jboss-eap-8/eap81-openjdk17-builder-openshift-rhel9:latest --confirm
```
