# Building an EAP 8 application image using EAP 8.2 S2I source build

In this example we are making use of the EAP 8.2 S2I builder and runtime images to build an EAP 8.2 server + JAX-RS application docker image on Openshift.
...
* User typical S2I workflow. Start from a github source repository, use latest released EAP 8.2 artifacts and images.
